...
public class MainActivity extends Activity implements OnClickListener{
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_suggest:
			 ...
			 * 没安装QQ的会跳到下载界面。
			 * 
			 * 有的手机会报找不到android.permission.WRITE_APN_SETTINGS权限
			 * Android 4.0以后的 google回收了这个权限。
			 * 4.0以后如想获得这个权限有两种方法：1、root。2、设置APK的UID和system的一样。
			 */
			mTencent.startWPAConversation(MainActivity.this,"943689625", "你好！");
			break;
